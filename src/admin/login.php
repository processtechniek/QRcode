...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password, role_id FROM tb_user WHERE username = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $login_err = "Verkeerde inloggegevens.";
                        }
                    }
                } else{
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" class="login-form" method="post">
            ...
            <div class="login-button">
                <input type="submit" class="input-button" value="Inloggen">
            </div>
        </form>
    </div>
